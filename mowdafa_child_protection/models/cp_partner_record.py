...
class CpPartnerRecord(models.Model):
    ...
    def _concern_id(self):
        """The partner form keys the concern as a fixed selection; the case
        points at the master table. Match on the label, adding the entry the
        first time a concern is carried across."""
        self.ensure_one()
