...
""",
    ...
    'data': [
        ...
        'report/cp_case_report.xml',
        'report/cp_handover_report.xml',
        'report/cp_registration_report.xml',
        'report/cp_verification_adult_report.xml',
        'report/cp_verification_child_report.xml',
        'report/cp_placement_report.xml',
        'report/cp_psychosocial_report.xml',
        'report/cp_daily_record_report.xml',
        'report/cp_mentoring_report.xml',
        'report/cp_reunification_report.xml',
        'report/cp_followup_report.xml',
        'report/cp_ministry_case_report.xml',
        'report/cp_partner_record_report.xml',
        'report/cp_caafag_registration_report.xml',
        'report/cp_caafag_verification_adult_report.xml',
        'report/cp_caafag_verification_child_report.xml',
        'report/cp_caafag_placement_report.xml',
        'report/cp_caafag_psychosocial_report.xml',
        'report/cp_caafag_daily_record_report.xml',
        'report/cp_caafag_mentoring_report.xml',
        'report/cp_caafag_reunification_report.xml',
        'report/cp_caafag_followup_report.xml',
        'report/cp_caafag_incident_report.xml',
